...
def tricolor(img):
    ...
    for i in range(len(img)):
        ...
        for j in range(len(img[i])):
            ...
            elif ((2 * width(img)) // 3) < j < width(img):
...
filters_dictionary = {"1": blur, "2": shades, "3": bnw, "4": tricolor, "5": bottom_right}
filters_dictionary_names = {"1": "blur", "2": "shades", "3": "bnw", "4": "tricolor", "5": "bottom right"}